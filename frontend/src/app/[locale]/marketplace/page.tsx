...
import { Search, ChevronLeft, ChevronRight, CheckCircle, Github, Star, Package } from 'lucide-react'
import { ApiSpec, SpecDetail, Tag } from '@/types/api-spec'
import { fetchSpecs, fetchSpecDetail, fetchTags, formatFileSize, formatDate } from '@/lib/api'
